                        ...
                        <Table className={useStyles.table}>
                            <TableHead>
                                <TableRow>
                                    ...
                                    <StyledTableCell style={{ backgroundColor: '#e89a00' }} align="left">Name</StyledTableCell>
                            ...
                            <TableBody>
                                {soldQuotsFiltered.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map(el => (
                                    <StyledTableRow className="row-tab-req" key={el.quotationNUM} component={Link} to={`/buyer_dashboard/purchases/o/${el._id}/${pathID}`}>
                                        ...
                                        <StyledTableCell align="left">{Object.keys(el.details[0]).length === 3 ? <Chip className={useStyles.chip} label={el.details[0].name1} color="primary" /> : <Chip className={useStyles.chip} label={el.details[0].name1 + '  ➕'} color="primary" />}</StyledTableCell>
                                        <StyledTableCell align="center">{el.details[0].description1}</StyledTableCell>
