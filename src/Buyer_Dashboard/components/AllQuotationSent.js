                        ...
                        <Table className={useStyles.table}>
                            <TableHead>
                                <TableRow>
                                    ...
                                    <StyledTableCell style={{ backgroundColor: '#0088ff' }} align="left">Name</StyledTableCell>
                                ...
                                {sentQuotsFiltered.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map(row => (
                                    <StyledTableRow className="row-tab-req" key={row.quotationNUM} component={Link} to={`/buyer_dashboard/req-sent/o/${row._id}/${row.status}/${pathID}`}>
                                        ...
                                        <StyledTableCell align="left">
                                            {row.details.map(x => (
                                                <div>
                                                    <Chip className={x.name1 === '' ? 'empty' : useStyles1.chip} label={x.name1} style={{ backgroundColor: '#3d04cc', color: 'white' }} />
                                                    <Chip className={x.name2 === '' ? 'empty' : useStyles1.chip} label={x.name2} style={{ backgroundColor: '#3d04cc', color: 'white' }} />
                                                    <Chip className={x.name3 === '' ? 'empty' : useStyles1.chip} label={x.name3} style={{ backgroundColor: '#3d04cc', color: 'white' }} />
                                                    <Chip className={x.name4 === '' ? 'empty' : useStyles1.chip} label={x.name4} style={{ backgroundColor: '#3d04cc', color: 'white' }} />
                                                </div>
                                            ))}
                                        </StyledTableCell>
